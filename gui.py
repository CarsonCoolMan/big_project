...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.label_enter_number = QLabel(Dialog)
        self.label_enter_number.setObjectName("label_enter_number")
        self.label_enter_number.setGeometry(QRect(270, 60, 61, 41))
        self.label_enter_number.setAlignment(Qt.AlignmentFlag.AlignLeft | Qt.AlignmentFlag.AlignVCenter)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_enter_number.setText(_translate("Voting Booth", " "))